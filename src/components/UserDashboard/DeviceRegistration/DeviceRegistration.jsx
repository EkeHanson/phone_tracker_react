...
const DeviceRegistration = () => {
  ...
  const handleDeviceSubmit = async (e) => {
    ...
    deviceData.append('user', localStorage.getItem('unique_user_id')); // Ensure this user_id exists
    deviceData.append('name', name);
    //deviceData.append('unique_user_id', localStorage.getItem('unique_user_id'));
